...
public class ResourceSet {
	...
	private List<ElevationData> resources;
	...
	public List<ElevationData> getResources() {
		if (resources == null) {
			resources = new ArrayList<ElevationData>();
		}
		
		return resources;
	}

	public void setResources(List<ElevationData> resources) {
