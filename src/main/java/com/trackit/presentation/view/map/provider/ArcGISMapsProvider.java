...
public class ArcGISMapsProvider extends SphericalMercatorMapProvider implements MapProvider {

	public ArcGISMapsProvider(MapType mapType, Location centerLocation ) {
		super(MapProviderType.ARC_GIS_MAPS, mapType, centerLocation);
...
//		return String.format( template, mapTile.getZoom(), mapTile.getY(), mapTile.getX());
//	}	
}
