 ...
 * 
 */
package com.trackit.presentation.view.data;

import java.util.Collection;

import com.trackit.business.common.Messages;
import com.trackit.business.domain.Activity;
import com.trackit.business.domain.ActivityMetadata;
...
public enum DataType implements Columnizable {
	...
	CALENDAR {
		@Override
		public FieldMetadata[] getFieldsMetadata() {
			Collection<FieldMetadata> fieldsMetadata = CalendarData.getFieldsMetadata(CalendarData.class.getName());
			return fieldsMetadata.toArray(new FieldMetadata[fieldsMetadata.size()]);
		}
	};
	...
	private static final String[] names = new String[] { "dataView.dataType.none", "dataView.dataType.document", "dataView.dataType.activity",
		...
		"dataView.dataType.coursePoint", "dataView.dataType.event", "dataView.dataType.device", "dataView.dataType.calendar" };
