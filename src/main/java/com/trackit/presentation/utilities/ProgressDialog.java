...
public class ProgressDialog extends JDialog {
    ...
    public ProgressDialog(JFrame parent, String message) {
        super(parent);
        init(message);
    	System.out.println( "Progress dialog: " + message);
    }

    public void setMessage(String message) {
//      lblMessage.setText(message);										//12335: 2018-07-07
        setTitle( message);													//12335: 2018-07-07
    	System.out.println( "Progress dialog update: " + message);
    }
