...
public enum FileType {
	...
	private static final String[] descriptions = { "fileType.gpx", "fileType.tcx", "fileType.fit",
		"fileType.kml", "fileType.fitlog", "fileType.csv", "fileType.nmea", "fileType.all" };
	private static final String[] filters = { "fileType.filter.gpx", "fileType.filter.tcx",
		"fileType.filter.fit", "fileType.filter.kml", "fileType.filter.fitlog",
		"fileType.filter.csv", "fileType.filter.nmea", "fileType.filter.all" };
