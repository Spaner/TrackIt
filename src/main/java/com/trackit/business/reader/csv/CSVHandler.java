...
public class CSVHandler extends DefaultHandler implements XMLFileHandler {
	...
	static String DefaultHeading = "No,Latitude,Longitude,Elevation,"+
			"TotalDistance,DistanceFromLast,Speed,HeartRate,Cadence,Power,Grade,Bearing";
...
//			throw ( e.getMessage());
	...
	private double parseDouble( String element) throws ParseException {
		try {
//			return Formatters.getDecimalFormat().parse(element).doubleValue();	//12335: 2017-08-05
			return Formatters.getDefaultDecimalFormat().parse(element).doubleValue();
		} catch (ParseException e) {
			return Double.NaN; 
		}
	}
