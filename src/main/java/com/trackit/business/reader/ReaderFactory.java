 ...
 * 
 */
package com.trackit.business.reader;
...
import com.trackit.business.reader.csv.CSVFileReader;
import com.trackit.business.reader.fit.FITFileReader;
import com.trackit.business.reader.fitlog.FitlogFileReader;
import com.trackit.business.reader.gpx.GPXFileReader;
import com.trackit.business.reader.kml.KMLFileReader;
import com.trackit.business.reader.nmea.NMEAFileReader;
import com.trackit.business.reader.tcx.TCXFileReader;
...
public class ReaderFactory {
	...
	public Reader getReader(File file, Map<String, Object> options) throws ReaderException {
		...
		case CSV:									//2016:06:03 - 12335 - added read support for CSV 
			return new CSVFileReader();
		case NMEA:
			return new NMEAFileReader();			//2018-04-08 - 12335 - added suport dor NMEA
		case ALL:
