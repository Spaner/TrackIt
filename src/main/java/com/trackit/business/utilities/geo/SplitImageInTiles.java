	...
	public static void main(String[] args) throws IOException {  
		...
		for (int x = 1; x <= rows; x++) {  
			for (int y = 1; y <= cols; y++) {  
				...
				file = new File("/Users/ga/Sandbox/MilitaryMaps/431/" + StringUtilities.pad(String.valueOf(y), '0', 2, StringUtilities.LEFT_PAD) + "_"
							+ StringUtilities.pad(String.valueOf(x), '0', 2, StringUtilities.LEFT_PAD) + ".jpg");
				file.mkdirs();
