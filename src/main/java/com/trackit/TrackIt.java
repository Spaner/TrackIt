...
import com.trackit.presentation.ApplicationPanel;
	...
	private static void createAndShowGUI() {
		...
		applicationFrame.addWindowListener(new java.awt.event.WindowAdapter() {
			...
			public void windowClosing(java.awt.event.WindowEvent windowEvent) {
				//12335: 2016-06-09: added arg value
				SaveTools.getInstance().saveAndExit( false, OperatingSystem.isMac());	
			}
		});
		// #####################################################################################
		...
		if (OperatingSystem.isMac()) {
			...
			macApp.setQuitHandler(new QuitHandler() {
				...
				public void handleQuitRequestWith(QuitEvent arg0, QuitResponse arg1) {
					// 12335: 2016-06-99 added args value for menu initiated TrackIt close on Mac
					SaveTools.getInstance().saveAndExit( true, true);
				}
			});
			// 12335 end
		}
...
//				DocumentManager.getInstance().openDocumentsFromDB();
				return null;
			}
