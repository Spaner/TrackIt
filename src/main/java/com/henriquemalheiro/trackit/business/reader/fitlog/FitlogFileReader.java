 ...
 * 
 */
package com.henriquemalheiro.trackit.business.reader.fitlog;
...
public class FitlogFileReader extends ReaderTemplate implements ErrorHandler {
	public FitlogFileReader() {
		this(new HashMap<String, Object>());
	}
	
	public FitlogFileReader(Map<String, Object> options) {
		super(options);
		setPreferences();
	}
	...
	public GPSDocument read(final InputStream inputStream, String filePath) throws ReaderException {//58406
		GPSDocument document = readXMLFile(inputStream, new FitlogHandler(options), this);
