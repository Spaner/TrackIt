...
//		course.setSport(session.getSport());									//12335: 2016-06-15
//		course.setSubSport(session.getSubSport());								//12335: 2016-06-15
		course.setSportAndSubSport( session.getSport(), session.getSubSport());	//12335: 2016-06-15
