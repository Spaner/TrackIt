...
public class CopyOperation extends OperationBase implements Operation {
	...
	private void copyOut(GPSDocument document) {
		...
		newCourse.setElapsedTime((course.getElapsedTime() == null) ? null : new Double(course.getElapsedTime()));
		newCourse.setTimerTime((course.getTimerTime() == null) ? null : new Double(course.getTimerTime()));
		newCourse.setMovingTime((course.getMovingTime() == null) ? null : new Double(course.getMovingTime()));
		newCourse.setPausedTime((course.getPausedTime() == null) ? null : new Double(course.getPausedTime()));
		newCourse.setDistance((course.getPausedTime() == null) ? null : new Double(course.getDistance()));
		newCourse.setAverageSpeed((course.getPausedTime() == null) ? null : new Double(course.getAverageSpeed()));
		newCourse.setAverageMovingSpeed((course.getPausedTime() == null) ? null : new Double(course.getAverageMovingSpeed()));
		newCourse.setMaximumSpeed((course.getPausedTime() == null) ? null : new Double(course.getMaximumSpeed()));
		newCourse.setAverageHeartRate((course.getAverageHeartRate() == null) ? null : new Short(course.getAverageHeartRate()));
		newCourse.setMinimumHeartRate((course.getMinimumHeartRate() == null) ? null : new Short(course.getMinimumHeartRate()));
		newCourse.setMaximumHeartRate((course.getMaximumHeartRate() == null) ? null : new Short(course.getMaximumHeartRate()));
		newCourse.setAverageCadence((course.getAverageCadence() == null) ? null : new Short(course.getAverageCadence()));
		newCourse.setMaximumCadence((course.getMaximumCadence() == null) ? null : new Short(course.getMaximumCadence()));
		newCourse.setAverageRunningCadence((course.getAverageRunningCadence() == null) ? null : new Short(course.getAverageRunningCadence()));
		newCourse.setMaximumRunningCadence((course.getMaximumRunningCadence() == null) ? null : new Short(course.getMaximumRunningCadence()));
		newCourse.setAveragePower((course.getAveragePower() == null) ? null : new Integer(course.getAveragePower()));
		newCourse.setMaximumPower((course.getMaximumPower() == null) ? null : new Integer(course.getMaximumPower()));
		newCourse.setCalories((course.getCalories() == null) ? null : new Integer(course.getCalories()));
		newCourse.setFatCalories((course.getFatCalories() == null) ? null : new Integer(course.getFatCalories()));
		newCourse.setAverageTemperature((course.getAverageTemperature() == null) ? null : new Byte(course.getAverageTemperature()));
		newCourse.setMinimumTemperature((course.getMinimumTemperature() == null) ? null : new Byte(course.getMinimumTemperature()));
		newCourse.setMaximumTemperature((course.getMaximumTemperature() == null) ? null : new Byte(course.getMaximumTemperature()));
		newCourse.setTotalAscent((course.getTotalAscent() == null) ? null : new Integer(course.getTotalAscent()));
		newCourse.setTotalDescent((course.getTotalDescent() == null) ? null : new Integer(course.getTotalDescent()));
		newCourse.setAverageAltitude((course.getAverageAltitude() == null) ? null : new Float(course.getAverageAltitude()));
		newCourse.setMinimumAltitude((course.getMinimumAltitude() == null) ? null : new Float(course.getMinimumAltitude()));
		newCourse.setMaximumAltitude((course.getMaximumAltitude() == null) ? null : new Float(course.getMaximumAltitude()));
		newCourse.setAverageGrade((course.getAverageGrade() == null) ? null : new Float(course.getAverageGrade()));
		newCourse.setAveragePositiveGrade((course.getAveragePositiveGrade() == null) ? null : new Float(course.getAveragePositiveGrade()));
		newCourse.setAverageNegativeGrade((course.getAverageNegativeGrade() == null) ? null : new Float(course.getAverageNegativeGrade()));
		newCourse.setMaximumPositiveGrade((course.getMaximumPositiveGrade() == null) ? null : new Float(course.getMaximumPositiveGrade()));
		newCourse.setMaximumNegativeGrade((course.getMaximumNegativeGrade() == null) ? null : new Float(course.getMaximumNegativeGrade()));
		newCourse.setAveragePositiveVerticalSpeed((course.getAveragePositiveVerticalSpeed() == null) ? null : new Float(course.getAveragePositiveVerticalSpeed()));
		newCourse.setAverageNegativeVerticalSpeed((course.getAverageNegativeVerticalSpeed() == null) ? null : new Float(course.getAverageNegativeVerticalSpeed()));
		newCourse.setMaximumPositiveVerticalSpeed((course.getMaximumPositiveVerticalSpeed() == null) ? null : new Float(course.getMaximumPositiveVerticalSpeed()));
		newCourse.setMaximumNegativeVerticalSpeed((course.getMaximumNegativeVerticalSpeed() == null) ? null : new Float(course.getMaximumNegativeVerticalSpeed()));
		newCourse.setStartLatitude((course.getStartLatitude() == null) ? null : new Double(course.getStartLatitude()));
		newCourse.setStartLongitude((course.getStartLongitude() == null) ? null : new Double(course.getStartLongitude()));
		newCourse.setStartAltitude((course.getStartAltitude() == null) ? null : new Double(course.getStartAltitude()));
		newCourse.setEndLatitude((course.getEndLatitude() == null) ? null : new Double(course.getEndLatitude()));
		newCourse.setEndLongitude((course.getEndLongitude() == null) ? null : new Double(course.getEndLongitude()));
		newCourse.setEndAltitude((course.getEndAltitude() == null) ? null : new Double(course.getEndAltitude()));
		newCourse.setNortheastLatitude((course.getNortheastLatitude() == null) ? null : new Double(course.getNortheastLatitude()));
		newCourse.setNortheastLongitude((course.getNortheastLongitude() == null) ? null : new Double(course.getNortheastLongitude()));
		newCourse.setSouthwestLatitude((course.getSouthwestLatitude() == null) ? null : new Double(course.getSouthwestLatitude()));
		newCourse.setSouthwestLongitude((course.getSouthwestLongitude() == null) ? null : new Double(course.getSouthwestLongitude()));
		
		
		newCourse.setUnsavedChanges(course.getUnsavedChanges());
		newCourse.setFilepath((course.getFilepath() == null) ? null : new String(course.getFilepath()));
		newCourse.setCreator((course.getCreator() == null) ? null : new String(course.getCreator()));
		...
		for (Picture picture : course.getPictures()){
