...
public enum Event {
    ...
    private static final String[] messageCodes = {"event.documentUpdated", "event.documentDiscarded",
        "event.nothingSelected", "event.documentsSelected", "event.documentAdded", "event.documentSelected", "event.documentChanged",
        "event.activitiesSelected", "event.activityAdded", "event.activitySelected", "event.activityRemoved", "event.coursesSelected",
        "event.courseSelected", "event.courseRemoved", "event.sessionsSelected", "event.sessionSelected", "event.lapsSelected", "event.lapSelected",
        ...
        "event.segmentsSelected", "event.segmentSelected", "event.courseUpdated", "event.folderSelected", "event.miscelaneousSelection",
