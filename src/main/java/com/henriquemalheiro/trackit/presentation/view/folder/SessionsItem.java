...
public class SessionsItem extends TrackItBaseType implements FolderTreeItem {
	private static ImageIcon icon = ImageUtilities.createImageIcon("laps_16.png");;
	private Activity parent;
	
	public SessionsItem(Activity activity) {
	...
	public String getFolderTreeItemName() {
		return getMessage("folderView.label.sessions");
	}
	...
	public void publishSelectionEvent(EventPublisher publisher) {
		EventManager.getInstance().publish(publisher, Event.SESSIONS_SELECTED, parent, parent.getSessions());
	}
