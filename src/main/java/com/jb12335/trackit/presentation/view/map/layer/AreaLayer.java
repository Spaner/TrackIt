 ...
 * 
 */
package com.jb12335.trackit.presentation.view.map.layer;
...
public class AreaLayer extends MapLayer implements EventPublisher {
...
//				DocumentManager.getInstance().openDocumentsForLibrary(documentFilenames);
